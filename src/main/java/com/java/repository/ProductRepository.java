...
public interface ProductRepository extends JpaRepository<Product, Integer> {
	...
	// sort sản phẩm theo giá tăng dần của từng danh mục (sort túi, kính, giày, balo
	// theo giá thông qua categoryID (giá bằng nhau thì id tăng dần)
	...
	// sort sản phẩm theo giá giảm dần của từng danh mục (sort túi, kính, giày, balo
	// theo giá thông qua categoryID (giá bằng nhau thì id tăng dần)
	...
	public List<Product> listProductByPriceInCategoryBetweenta_b(Integer categoryId, Integer minPrice,
			Integer maxPrice);
	...
	public List<Product> listProductByPriceInCategoryBetweenta_b_ASC(Integer categoryId, Integer minPrice,
			Integer maxPrice);
	...
	public List<Product> listProductByPriceInCategoryBetweenta_b_DESC(Integer categoryId, Integer minPrice,
			Integer maxPrice);
}
